...
// ReportActionActivities : Chứa thông tin insert vào bảng report_action_activities của user
type ReportActionActivities struct {
	...
	//
	TotalFacebookShareNowService int `json:"total_facebook_ShareNow" bson:"total_facebook_ShareNow"`
...
type ReportActionActivitiesReq struct {
	Token     string
	DeviceID  string
	StartTime *time.Time
	EndTime   *time.Time
