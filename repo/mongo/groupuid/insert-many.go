...
// InsertMany ..
func (r Repo) InsertMany(data []model.GroupUIDInfo) (err error) {
...
func (r Repo) InsertManyWithSessionCtx(sessionCtx context.Context, data []model.GroupUIDInfo) (err error) {
